<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendUserNotification.aspx.cs" Title="RMC :: Notification"
    Inherits="RMC.Web.Users.SendUserNotification" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        <asp:TextBox ID="TextBoxMessage" runat="server" Height="91px" MaxLength="4000" TabIndex="4"
                                            TextMode="MultiLine" Width="215px" ForeColor="#06569D" 
                                            ondatabinding="TextBoxMessage_PreRender" oninit="Page_Load" 
                                            onprerender="TextBoxMessage_PreRender"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="padding-top: 5px;">
                                        <asp:Button ID="ButtonSend" runat="server" Text="Send" ValidationGroup="UserRegistration"
                                            CssClass="aspButton" Width="70px" TabIndex="28" Style="height: 26px" 
                                            onclick="ButtonSend_Click" />
                                        &nbsp;
                                        <asp:Button ID="ButtonClose" runat="server" OnClientClick="return window.close();" Text="Close" CssClass="aspButton" Width="70px"
                                            TabIndex="28" Style="height: 26px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="190px">
