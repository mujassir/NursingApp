<%@ Page Language="C#" MasterPageFile="~/Administrator/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="UserRegistration.aspx.cs" Inherits="RMC.Web.Administrator.UserRegistration"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="99%">
                    ...
                    <div id="divErrorMsgInner" style="width: 418px; float: left; background-color: #E8E9EA;
                        ...
                        <div style="padding-left: 90px;">
                            <asp:ValidationSummary ID="ValidationSummaryUserRegistration" ValidationGroup="UserRegistration"
                                runat="server" DisplayMode="BulletList" Font-Size="11px" Font-Bold="true" 
                                Style="padding-top: 1px;" ShowMessageBox="True" ShowSummary="False" />
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="TextBoxCompanyName" MaxLength="100" runat="server" TabIndex="1" Width="160px"></asp:TextBox>
