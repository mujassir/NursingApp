<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportTimeRN.ascx.cs"
    Inherits="RMC.Web.UserControls.ReportTimeRN" %>
...
<table width="99%" visible="false">
    <tr>
        <td colspan="4px" align="left" style="font-size: 14px; padding-left: 10px; padding-top: 10px;
            color: #06569d;">
    ...
    <tr>
        <td colspan="4px">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" AutoScroll="false"
                Font-Size="8pt" AsyncRendering="False" SizeToReportContent="True" DocumentMapWidth="100%"
                Width="100%">
                <LocalReport ReportPath="RDLC\ReportTimeStudyRN.rdlc">
                    <DataSources>
                        ...
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource3" Name="BEFunctionNames1" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
        </td>
...
<asp:ObjectDataSource ID="ObjectDataSource3" runat="server" OnSelecting="ObjectDataSource1_Selecting"
    SelectMethod="GetPerformanceTest" TypeName="RMC.BussinessService.BSReports">
    <SelectParameters>
        ...
        <asp:Parameter Name="dataPointsFrom" Type="Int32"></asp:Parameter>
        <asp:Parameter DefaultValue="" Name="optDataPointsFrom" Type="Int32"></asp:Parameter>
        <asp:Parameter Name="dataPointsTo" Type="Int32"></asp:Parameter>
        <asp:Parameter DefaultValue="" Name="optdataPointsTo" Type="Int32"></asp:Parameter>
    </SelectParameters>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OnSelecting="ObjectDataSource1_Selecting"
    SelectMethod="GetDataForTimeRNSummaryTest" TypeName="RMC.BussinessService.BSReports">
    <SelectParameters>
        <asp:Parameter DefaultValue="" Name="valueAddedCategoryID" Type="String"></asp:Parameter>
        <asp:Parameter DefaultValue="" Name="OthersCategoryID" Type="String"></asp:Parameter>
        <asp:Parameter DefaultValue="" Name="LocationCategoryID" Type="String"></asp:Parameter>
